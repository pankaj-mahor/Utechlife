...
import chromatography from "@assets/generated_images/chromatography.jpg";
import consumablesImage from "@assets/generated_images/Laboratory_consumables_products_1cb1d2c8.png";
import waterSystemsImage from "@assets/generated_images/Water_purification_systems_9edfe2fb.jpeg";
  ...
  const productCategories = [
    {
      ...
      description:
        "High-performance chromatography columns and separation solutions for analytical and preparative applications.",
      products: [
        "HPLC Columns",
        "UPLC Columns",
    ...
    },
    {
      ...
      description:
        "Essential laboratory supplies and consumables for daily analytical operations and sample preparation.",
      products: [
        "Syringe Filters",
        "Vials",
        "HPLC Tubings",
    ...
    },
    {
      ...
      description:
        "Type I & Type II water systems for critical laboratory applications requiring ultra-pure water.",
      products: [
        "Type I Water Systems",
        "Type II Water Systems",
        "Filtration Units",
        "Monitoring Systems",
      ],
      featured: false,
      ...
      <div className="container mx-auto max-w-6xl px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            We bring a wide range of products to cater to the evolving needs of
            scientists, researchers, and quality professionals.
          </p>
        </div>
