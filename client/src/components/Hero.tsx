    ...
    <section className="relative h-[70vh] min-h-[500px] flex items-center">
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-6">
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-gray-200 mb-8 leading-relaxed">
            Trusted provider of high-performance chromatography columns, laboratory instruments, 
            and consumables for pharmaceutical, biotechnology, and research institutions.
          </p>
      ...
      <div className="absolute bottom-8 left-0 right-0 z-10">
        <div className="container mx-auto max-w-6xl px-6">
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-8 text-white/80">
